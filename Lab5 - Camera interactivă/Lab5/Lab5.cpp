...
public:
	...
	void ProcessKeyboard(EMovementType movementType, double deltaTime)
	{
		float velocity = deltaTime * cameraSpeedFactor;
		switch (movementType)
		{
		case Camera::EMovementType::ENone:
			break;
		case Camera::EMovementType::EForward:
			this->position += this->forward * velocity;
			break;
		case Camera::EMovementType::EBackward:
			this->position -= this->forward * velocity;
			break;
		case Camera::EMovementType::ELeft:
			this->position -= this->right * velocity;
			break;
		case Camera::EMovementType::ERight:
			this->position += this->right * velocity;
			break;
		case Camera::EMovementType::EPageUp:
			this->position += this->up * velocity;
			break;
		case Camera::EMovementType::EPageDown:
			this->position -= this->up * velocity;
			break;
		default:
			break;
