...
int main(int argc, char** argv)
{
	...
	// Create camera
	pCamera = new Camera(SCR_WIDTH, SCR_HEIGHT, glm::vec3(-2.5, 2.0, 10.0));
...
void renderScene(const Shader& shader)
{
	...
	model = glm::mat4();
	model = glm::translate(model, glm::vec3(-2.5f, 3.0f, -2.0f));
	model = glm::scale(model, glm::vec3(0.75f));
	model = glm::rotate(model, glm::radians(30.f), glm::vec3(2.5f, 0.5f, 0.0f));
	shader.SetMat4("model", model);
	renderCube();

	model = glm::mat4();
	model = glm::translate(model, glm::vec3(-1.0f, 2.25f, 2.0f));
	model = glm::scale(model, glm::vec3(0.75f));
	model = glm::rotate(model, glm::radians(60.0f), glm::vec3(-2.5f, 0.5f, 2.0f));
	shader.SetMat4("model", model);
	renderCube();
	...
	model = glm::scale(model, glm::vec3(0.75f));
	model = glm::rotate(model, glm::radians(135.0f), glm::vec3(2.5f, 0.5f, 2.5f));
	shader.SetMat4("model", model);
	renderCube();
}
